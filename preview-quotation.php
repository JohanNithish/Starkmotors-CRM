...
$Type_client = "<b>Quotation</b> - SQ".$QUOTATION_id."<br> ".
      
      "<b>The details of your quotation are given below: </b><br><br>";

$Type_stark = "<b>Quote for Energy Efficient Motors </b> - SQ".$QUOTATION_id."<br> ".
...
$message   .=  '<table class="no-bdr" width="100%" cellpadding="5px" style="padding:15px;line-height:2;background-color:#e8e8e8;border: 2px solid #000;">
                 <tr nobr="true"><td style="width:50%;line-height:1; border-width:0px; margin:0px;padding: 0px 10px;"><b class="adds-titl" ><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bank Details </b><br><br><img src="https://crm.starkmotors.com/assets/images/Our/qr3.png" width="135px" ><br><br></td>
                 <td style="width:50%;line-height:1;padding: 0px 10px; border-width:0px;text-align:right;margin:0px;"><b class="adds-titl" ><br>Website&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><br><br><img src="https://crm.starkmotors.com/assets/images/Our/qr2.png" width="135px" ><br><br></td></tr></table>';
}
else{
  $message   .=  '<table class="no-bdr" width="100%" cellpadding="5px" style="padding:15px;line-height:2;background-color:#e8e8e8;border: 2px solid #000;">
                <tr nobr="true"><td style="width:50%;line-height:1; border-width:0px; margin:0px;padding: 0px 10px;"><b class="adds-titl" ><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bank Details </b><br><br><img src="https://crm.starkmotors.com/assets/images/Our/qr1.png" width="135px" ><br><br></td>
                <td style="width:50%;line-height:1;padding: 0px 10px; border-width:0px;text-align:right;margin:0px;"><b class="adds-titl" ><br>Website&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><br><br><img src="https://crm.starkmotors.com/assets/images/Our/qr2.png" width="135px" ><br><br></td></tr></table>
';
}
...
<h6 class="mb-0 text-uppercase">Preview Quotation</h6>

<div class="ms-auto">
<div class="col">
<a href="add-quotation.php?id=<?=$ID; ?>" class="btn btn-danger px-3 ">Back</a>
<!-- Modal -->
</div>
</div>
</div><hr/>
