...
$Type_client = "<b>Proforma	Invoice</b> - ".$enquiry_num."<br> ".
      
      "<b>The details of your order are given below: </b><br><br>";

$Type_stark = "<b>New Invoice Created </b> - ".$enquiry_num."<br> ".
...
$subject="Proforma Invoice for #".$SALES_id;
$stark_subject="Proforma Invoice for Energy Efficient Motors #".$SALES_id;
...
<h6 class="mb-0 text-uppercase">Preview Invoice</h6>

<div class="ms-auto">
<div class="col">
<a href="add-sales.php?id=<?=$ID; ?>&act=edit" class="btn btn-danger px-3 ">Back</a>
<!-- Modal -->
</div>
</div>
</div><hr/>
