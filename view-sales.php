...
<?  $select_sales=mysqli_query($conn,"select * from order_confirmation where id='$ID'"); 
...
<?   $sel_dispatch=mysqli_query($conn,"select (select count(total_dispatch) from ordered_products where sales_id = '$ID' and quantity=total_dispatch ) as totDispatch  ");
$row_dispatch=mysqli_fetch_array($sel_dispatch);
$totDispatch=$row_dispatch['totDispatch'];
$remDispatch=$products_count-$totDispatch;
if($remDispatch==0){
  $RemProduct="Dispatched"; 
}else{
   $RemProduct="Remaining ".$remDispatch." products"; 
}
 ?>
<div class="card border-0 border-4 ">
  <h5 class="p-2 text-center view-hdr fw-3">Dispatch Details</h5>
<div class="card-body p-5">
<div class="row g-3">
<?  if($status!=''){ 
 ?>
...
<div class="col-md-6 bdr-tp-gray">
 <p for="client_name" class="client mb-0"><?=$totDispatch;?></p>
...
<div class="card border-0 border-4 ">
  <h5 class="p-2 text-center view-hdr fw-3">Sales Details</h5>
<div class="card-body p-5">
<div class="row g-3">
<?if($created_datetime!=''){
...
?>
<div class="col-md-6 pb-2">
<h6 for="inputFirstName" class="form-label mb-0">Converted Time Period</h6>
</div>

<div class="col-md-6 pb-2">
 <p for="client_name" class="client mb-0"><span><?=$Sales_conv;?><br><?=date("d-m-Y", strtotime($quotation_createdDate))." to ".date("d-m-Y", strtotime($created_datetime)); ?></span></p>
</div> 
<? }
if($products_count!=''){?>
<div class="col-md-6 bdr-tp-gray">
...
<? } if($invoice_date!=''){?>
<div class="col-md-6 bdr-tp-gray">
<h6 for="inputFirstName" class="form-label mb-0">PO Date</h6>
</div>

<div class="col-md-6 bdr-tp-gray">
 <p for="client_name" class="client mb-0"><?=date("d-m-Y", strtotime($invoice_date));?></p>
</div> 
<? } if($company_address !=''){?>
<div class="col-md-6 bdr-tp-gray">
<h6 for="inputFirstName" class="form-label mb-0">Company Name</h6>
...
<? } if($enquiry_num!=''){?>
<div class="col-md-6 bdr-tp-gray">
<h6 for="inputFirstName" class="form-label mb-0">Customer PO No.</h6>
</div>

<div class="col-md-6 bdr-tp-gray">
 <p for="client_name" class="client mb-0"><?=$enquiry_num;?> </p>
</div> 
<? } if($refered_by!=''){?>
<div class="col-md-6 bdr-tp-gray">
<h6 for="inputFirstName" class="form-label mb-0">Job Card No</h6>
</div>

<div class="col-md-6 bdr-tp-gray">
 <p for="client_name" class="client mb-0"><?=$refered_by;?> </p>
</div> 
<? } if($terms_condition!=''){?>
<div class="col-md-6 bdr-tp-gray">
...
<div class="col-md-3 ">
<label for="inputLastName" class="form-label mt-20 mb-0">Product Info</label>
...
$dispatch_num=$row_product['dispatch_num'];
...
<p class="my-2"><span class="fw-500"><b><?=$product_name;?></b></span><?=$metrics;?></p>
<p class="align-self-end mb-2 w-100"><b>Est. Deliv. Date: </b> <? if($estimated_delivery!=''){echo date("d-m-Y", strtotime($estimated_delivery));}else{echo '--';}?></p>
</div>
<div class="w-12">
