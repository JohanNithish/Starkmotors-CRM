...
$sel_rows=mysqli_query($conn,"select * from order_confirmation where id='$ID' ");
...
//     $Customer_PO="";
//   }
 $htmlData   .=  '<table style="padding:5px 5px;"><tr style="vertical-align: middle;"><td style="width:30%;" ><p class="adds-titl" ><a href="www.starkmotors.com" target="_blank" style="text-align:center;"><img src="assets/images/Our/logo2.png" width="95px;"></a></p></td><td width="70%" style="border:1px solid #000;"><p class="adds-titl" style="text-align:left;font-size:12px;line-height:15px;font-weight:normal;">'.$Address_2.'<br>&nbsp;&nbsp;Phone: + 91 94426 14612, + 91 98433 14612,<br>&nbsp;&nbsp;Landline: 0422 -2627672, 0422 -2627612, 0422 -4274969, 0422 -4385612,<br>&nbsp;&nbsp;E-mail:sales@starkmotors.com<br>&nbsp;&nbsp;GST:'.$Gst_address.'</p></td></tr></table>';

// PROFORMA ENTRANCE
// SALES ACKNOWLEDGEMENT
$htmlData   .=  '<table style="padding:5px 5px;"><tr style="background-color:#287dcf;color:#fff"><td style="width:100%;" ><h1 style="text-align:center;font-size:14px;color:#fff;">PROFORMA INVOICE</h1></td></tr><tr><td style="width:50%;" ><p class="adds-titl" style="line-height:1.3;font-size:11px;" ><b>PO No: '.$enquiry_num.'</b>'.$job_card_no.'<br><b>No of Items: '.$products_count.'</b></p></td><td style="width:50%;" ><p style="font-size:11px;line-height:1.3;" ><b>PO Date: '.date('d-m-Y', strtotime($invoice_date)).' </b><br><b>Total Amount: Rs. '.$total_order_amount.'</b>'.$Customer_PO.'</p></td></tr><tr><td style="width:50%;" ><p class="adds-titl" style="line-height:1.4;font-size:11px;" ><b>To,</b><br> <span>&nbsp;&nbsp;&nbsp;&nbsp;'.$company_name.''.wordwrap($address, 45, "<br />&nbsp;&nbsp;&nbsp;&nbsp;\n").' '.$state.$Pin_code.''.$GST.'</span></p></td><td style="width:50%;font-size:11px;" ><b>Contact Person Name:</b>&nbsp;&nbsp;&nbsp;'.$customer_name.'<br><b>Phone:&nbsp;&nbsp;</b>'.$mobile.'<br><b>Email:&nbsp;&nbsp;</b>'.$email.'</td></tr></table>';
...
$SNo=0;
$sel_product=mysqli_query($conn,"select * from ordered_products where sales_id='$ID' ");
...
<td style="text-align:center;width:11%;font-size:10px;border: 1px solid #000;border-bottom: 1px solid #000;">Rs.'.$product_amount.'</td> 
...
$sel_gstTax=mysqli_query($conn,"SELECT *,COALESCE(SUM(gst_amount),0) as totalgst, COALESCE(SUM(product_amount),0) as tproductamt FROM ordered_products where sales_id='$ID' GROUP BY gst ");
...
$htmlData .= '<tr ><td class="tb-row" style="width:60%; font-weight: normal;font-size:11px;border: 1px solid #000;border-bottom: 1px solid #000;font-size:11px;background-color:#ffff92;text-align:right;"><b>Net Amount</b></td>  
...
$htmlData .= '<table style="padding:10px;">
</table>';
if($terms_condition!=''){
$htmlData   .=  '<table nobr="true" cellpadding="0px" style="border-spacing: 6px 5px;padding:5px 5px;border: 1px solid #000;border-bottom: 0px solid #000;">
<tr class="no-bdr" nobr="true"><td style="width:100%;font-size:12px;" height="2" ><b>Terms & Conditions:</b></td></tr>
                 <tr class="no-bdr"><td style="width:100%;font-size:11px;" >'.$terms_condition.'
                </td></tr></table>';
}
